...
public class SCALP {
    ...
    public static void main(String[] args) {
        ...
        try {
            main.gpio = new GpioControllerContainer();
            main.gpio.getGPIO().setShutdownOptions(true);
            main.buttonList = new GpioPinDigitalInput[3];
           //Create 3 buttons. 
            for (int i = 0; i < 3; i++) {
                GpioPinDigitalInput button = main.gpio.getGPIO().provisionDigitalInputPin(RaspiPin.getPinByAddress(i+4), PinPullResistance.PULL_DOWN);
    ...
    private void removeHWButtons() {
        ...
        for (int i = 0; i < buttonList.length; i++) {
            ...
            gpio.getGPIO().unprovisionPin(buttonList[index]);
        }
    }
